...
<div class=default_width>
	<div class="search_bottom_box mt-3">
		...
		<div>
			<input type='date' id="checkin" min="${today }" value="${checkin }" class="main_checkin_1" name="checkin" onchange="dateChk()" required>
		</div>
		<div>
			<input type='date' id="checkout" min="${tomorrow }" value="${checkout }" class="main_checkout_1" name="checkout" onchange="dateChk()" style="border:none;" required>
		</div>
				...
				<div class="search_list_box">
					<form action="${pageContext.request.contextPath}/reservation/detail" class="search_list_abox" method="get">
						...
						<div class="reserve_room" style="width:690px; margin-top: 0px; padding-left:385px;">
						  ...
						  <strong class="search_room_title" style="width:300px;">${bu.bu_title}</strong>
						  <div class="reserve_room_price row" style="width:300px;">
						    <div class="col-sm-6">
						      <strong class="medium_text">가격</strong>
						    </div>
						    <div class="col-sm-6 right_text">
						      <b class="large_text"><fmt:formatNumber value="${minPriceMap[bu.pic_num] }" pattern="#,###" />원</b>
						    </div>
						  </div>

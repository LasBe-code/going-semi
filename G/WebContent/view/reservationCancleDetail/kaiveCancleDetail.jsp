...
<div class="default_width container-fluid">
  <div class="row">
    ...
    <p class="reservationDetail_head_cancle">취소완료</p>
      <p class="reservationDetail_medium_text"><b>부산 카이브펜션</b></p>
      <p class="reservationDetail_small_text" >3호<b>ㆍ</b>1박</p><br>
      <p class="reservationDetail_default_text">체크인&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2021.11.15 월 16:00</p>
      ...
      <p class="reservationDetail_noti_text">ⓘ휴대폰 번호 01012341234은(는)<br>
       ...
       <p class="reservationDetail_default_text">총 환불금액&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="reservationDetail_pay">-250,000원</b></p><br>
